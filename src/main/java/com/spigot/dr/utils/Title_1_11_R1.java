...
public class Title_1_11_R1 {
     ...
     * @param title Title
     */
    public Title_1_11_R1(String title) {
        this.title = title;
        loadClasses();
    }
    /**
     ...
     */
    public Title_1_11_R1(String title, String subtitle) {
        this.title = title;
     ...
     * @param title Title
     */
    public Title_1_11_R1(Title_1_11_R1 title) {
        // Copy title
     ...
     */
    public Title_1_11_R1(String title, String subtitle, int fadeInTime, int stayTime,
                 int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
    ...
    public void updateTimes(Player player) {
        if (Title_1_11_R1.packetTitle != null) {
            try {
                Object handle = getHandle(player);
                Object connection = playerConnection.get(handle);
                Object[] actions = Title_1_11_R1.packetActions.getEnumConstants();
                Object packet = Title_1_11_R1.packetTitle.getConstructor(
                        new Class[]{Title_1_11_R1.packetActions, chatBaseComponent,
            ...
            try {
                ...
                Object serialized = nmsChatSerializer.getConstructor(
                        ...
                        .newInstance(titleColor +
                                ChatColor.translateAlternateColorCodes('&',
                                        this.title));
                Object packet = Title_1_11_R1.packetTitle
                        .getConstructor(
                                new Class[]{Title_1_11_R1.packetActions,
