...
public class Title_1_9_R1 {
     ...
     *            Title
     */
    public Title_1_9_R1(String title) {
        this.title = title;
        loadClasses();
    }
    /**
     ...
     *            Subtitle text
     */
    public Title_1_9_R1(String title, String subtitle) {
        this.title = title;
     ...
     *            Title
     */
    public Title_1_9_R1(Title_1_9_R1 title) {
        // Copy title
     ...
     *            Fade out time
     */
    public Title_1_9_R1(String title, String subtitle, int fadeInTime, int stayTime,
                 int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
    ...
    public void updateTimes(Player player) {
        if (Title_1_9_R1.packetTitle != null) {
            try {
                Object handle = getHandle(player);
                Object connection = getField(handle.getClass(),
                        "playerConnection").get(handle);
                Object[] actions = Title_1_9_R1.packetActions.getEnumConstants();
                Method sendPacket = getMethod(connection.getClass(),
                        "sendPacket");
                Object packet = Title_1_9_R1.packetTitle.getConstructor(
                        new Class[] { Title_1_9_R1.packetActions, chatBaseComponent,
            ...
            try {
                ...
                Object serialized = nmsChatSerializer.getConstructor(
                        ...
                        .newInstance(
                                ChatColor.translateAlternateColorCodes('&',
                                        this.title));
                Object packet = Title_1_9_R1.packetTitle
                        .getConstructor(
                                new Class[] { Title_1_9_R1.packetActions,
